...
export default function Page() {
  const {
    postDetail: { title, categoryName, content, hashtags: initialData },
  ...
  const [newCateogryName, setCategoryName] = useState<string>(categoryName);
        ...
        <div className="flex gap-20">
          ...
          <div className="flex gap-12 font-pretendard font-medium">
            ...
            <Button
              ...
              onClick={() =>
                handleSubmitPost(
                  { title: newTitle, categoryName: newCateogryName },
                  'publish',
                )
              }
            >
